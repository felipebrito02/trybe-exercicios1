...
firstLi.addEventListener('click', clickClasse);
secondLi.addEventListener('click', clickClasse);
thirdLi.addEventListener('click', clickClasse);
...
myWebpage.addEventListener('dblclick', () => {
  window.location.replace('https://felipebrito02.github.io/');
});
